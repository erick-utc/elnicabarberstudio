    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-4 w-full">
                <div>
                    <form action="{{ route('reporte.paquetesPorFecha') }}" method="post">
                        @csrf
                ...
                <table class="w-full my-8">
                    <thead class="bg-gray-200">
                        <tr class="border-b">
                            ...
                            <th class="p-5 text-left">Descricion</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="p-5">{{$resultado->paquete_id}}</td>
                            <td class="p-5">{{$resultado->paquete->nombre}}</td>
                            <td class="p-5">{{$resultado->paquete->descripcion}}</td>
                            <td class="p-5">{{$resultado->total}}</td>
                        </tr>
                         @endforeach
                    </tbody>
                </table>
