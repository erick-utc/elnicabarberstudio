                ...
                <!-- <x-welcome /> -->
                 <form action="{{ route('role.store') }}" method="POST">
                    ...
                    <div>
                        ...
                        <div class="my-3">
                            <input value="{{ old('name') }}" placeholder="Ingrese el nombre del role" name="name" type="text" class="border-gray-300 shadow-sm w-1/2 rounded-lg">
                            @error('name')
                        ...
                        <div class="grid grid-cols-4 mb-3">
                            @foreach ($permisos as $permiso)
                                <div class="mt-3">
                                    <x-checkbox type="checkbox" id="permiso-{{ $permiso->id }}" name="permisos[]" value="{{ $permiso->name }}" />
